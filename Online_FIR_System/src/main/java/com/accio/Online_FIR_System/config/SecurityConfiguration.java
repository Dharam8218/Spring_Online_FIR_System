...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .requestMatchers("/OnlineFirSystem/add-police-station", "/admin-home", "/add-officer", "/add-police-station","/OnlineFirSystem/complain-summary").hasRole("ADMIN")
                .requestMatchers("/OnlineFirSystem/get-all-complains", "/officer-home","/OnlineFirSystem/complain-summary").hasRole("OFFICER")
